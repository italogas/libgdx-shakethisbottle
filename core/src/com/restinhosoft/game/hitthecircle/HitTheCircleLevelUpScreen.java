 ...
 *
 */
public class HitTheCircleLevelUpScreen implements Screen {
//********************LOGICS*****************************************
...
//********************GRAPHICS***************************************
	...
	private Texture hitTheCircleGameLevelUpYellow;
	private Texture hitTheCircleGameLevelUpRed;
	private Texture hitTheCircleGameBackGroundScreen;
	...
	public HitTheCircleLevelUpScreen(int score, int level,int bonus) {
		this.score= score;
		this.level= level;
		this.bonus= bonus;
	...
	public void show() {
		...
		okBT.addListener(new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				game.setScreen(new HitTheCircleGameScreen(score,level,bonus));
			}
		});
		            ...
		            public void run() {  
		                try { 
		                	if(showTimer >= 0){
		                		okBT.setVisible(false);
		                		if(showTimer%2==0){
		                			hitTheCircleGameBackGroundScreen = hitTheCircleGameLevelUpRed;
		                		}else {hitTheCircleGameBackGroundScreen = hitTheCircleGameLevelUpYellow;}
		                		showTimer--;
	...
	public void render(float delta) {
		...
		game.batch.begin();
		game.batch.draw(hitTheCircleGameBackGroundScreen, 0, 0);
		game.batch.end();
	...
	public void dispose() {
		...
		hitTheCircleGameBackGroundScreen.dispose();
		hitTheCircleGameLevelUpYellow.dispose();
		hitTheCircleGameLevelUpRed.dispose();
