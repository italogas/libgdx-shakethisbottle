 ...
 *
 */
public class DoNotShakeThisBottleLevelUpScreen implements Screen {
//********************LOGICS*****************************************
...
//********************GRAPHICS***************************************
	...
	private Texture donotshakethebottleGameLevelUpYellow;
	private Texture donotshakethebottleGameLevelUpRed;
	private Texture donotshakethebottleGameBackGroundScreen;
	...
	public DoNotShakeThisBottleLevelUpScreen(int score, int level,int bonus) {
		this.score= score;
		this.level= level;
		this.bonus= bonus;
	...
	public void show() {
		...
		donotshakethebottleGameLevelUpYellow = new Texture(Gdx.files.internal(
				 								 "donotshakethisbottle/shakethebottle_levelup_yellow.png"));
		donotshakethebottleGameLevelUpRed   = new Texture(Gdx.files.internal(
												 "donotshakethisbottle/shakethebottle_levelup_red.png"));
		
		donotshakethebottleGameBackGroundScreen = donotshakethebottleGameLevelUpYellow;
		            ...
		            public void run() {  
		                try { 
		                	if(showTimer >= 0){
		                		okBT.setVisible(false);
		                		if(showTimer%2==0){
		                			donotshakethebottleGameBackGroundScreen = donotshakethebottleGameLevelUpRed;
		                		}else {donotshakethebottleGameBackGroundScreen = donotshakethebottleGameLevelUpYellow;}
		                		showTimer--;
	...
	public void render(float delta) {
		...
		game.batch.begin();
		game.batch.draw(donotshakethebottleGameBackGroundScreen, 0, 0);
		game.batch.end();
	...
	public void dispose() {
		...
		donotshakethebottleGameBackGroundScreen.dispose();
		donotshakethebottleGameLevelUpYellow.dispose();
		donotshakethebottleGameLevelUpRed.dispose();
