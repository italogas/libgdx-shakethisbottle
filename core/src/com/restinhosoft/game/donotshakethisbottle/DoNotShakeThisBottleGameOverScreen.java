 ...
 *
 */
public class DoNotShakeThisBottleGameOverScreen implements Screen {
//********************LOGICS*****************************************
...
//********************GRAPHICS***************************************
	...
	private Texture shakethisbottleGameOverBKG;
	...
	public void show() {
		...
		shakethisbottleGameOverBKG = new Texture(Gdx.files.internal(
				 								 "donotshakethisbottle/shakethebottle_gameover.png"));
	...
	public void render(float delta) {
		...
		game.batch.begin();
		game.batch.draw(shakethisbottleGameOverBKG, 0, 0);
		game.batch.end();
