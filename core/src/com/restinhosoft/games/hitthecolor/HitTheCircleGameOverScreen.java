 ...
 *
 */
public class HitTheCircleGameOverScreen implements Screen {
//********************LOGICS*****************************************
...
//********************GRAPHICS***************************************
	...
	private Texture hitTheCircleGameOverBKG;
	...
	public void render(float delta) {
		...
		game.batch.begin();
		game.batch.draw(hitTheCircleGameOverBKG, 0, 0);
		game.batch.end();
	...
	public void dispose() {
		...
		hitTheCircleGameOverBKG.dispose();
