 ...
 * 
 */
package com.restinhosoft.games.shakethebottle;
 ...
 *
 */
public class ShakeThisBottleLevelUpScreen implements Screen {
//********************LOGICS*****************************************
...
//********************GRAPHICS***************************************
	...
	private Texture shakethebottleGameLevelUpYellow;
	private Texture shakethebottleGameLevelUpRed;
	private Texture shakethebottleGameBackGroundScreen;
	...
	public ShakeThisBottleLevelUpScreen(int score, int level,int bonus) {
		this.score= score;
		this.level= level;
		this.bonus= bonus;
		            ...
		            public void run() {  
		                try { 
		                	if(showTimer >= 0){
		                		okBT.setVisible(false);
		                		if(showTimer%2==0){
		                			shakethebottleGameBackGroundScreen = shakethebottleGameLevelUpRed;
		                		}else {shakethebottleGameBackGroundScreen = shakethebottleGameLevelUpYellow;}
		                		showTimer--;
	...
	public void render(float delta) {
		...
		game.batch.begin();
		game.batch.draw(shakethebottleGameBackGroundScreen, 0, 0);
		game.batch.end();
	...
	public void dispose() {
		...
		shakethebottleGameBackGroundScreen.dispose();
		shakethebottleGameLevelUpYellow.dispose();
		shakethebottleGameLevelUpRed.dispose();
