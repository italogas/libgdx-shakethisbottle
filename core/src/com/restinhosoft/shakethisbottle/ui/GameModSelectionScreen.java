 ...
 *
 */
public class GameModSelectionScreen implements Screen {
	...
	private TextButton survivaltxBT;
	...
	public void show() {
		...
		normaltxBT = new TextButton("NORMAL GAME MOD", textButtonEnableStyle);
		...
		survivaltxBT = new TextButton("SURVIVAL GAME MOD", textButtonEnableStyle);
		survivaltxBT.addListener(new ChangeListener(){
			@Override
			public void changed(ChangeEvent event, Actor actor) {
				game.setScreen(new SurvivalModScreen());		
			}
		});
